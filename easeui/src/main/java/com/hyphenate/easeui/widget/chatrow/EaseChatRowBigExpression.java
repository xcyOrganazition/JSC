...
import com.hyphenate.easeui.utils.GlideUtilsInEase;
    ...
    public void onSetUpView() {
        ...
        if (emojicon != null) {
            if (emojicon.getBigIcon() != 0) {
                GlideUtilsInEase.loadEaseImage(activity, emojicon.getBigIcon(), R.drawable.ease_default_expression, imageView);
            } else if (emojicon.getBigIconPath() != null) {
                GlideUtilsInEase.loadEaseImage(activity, emojicon.getBigIconPath(), R.drawable.ease_default_expression, imageView);
            } else {
