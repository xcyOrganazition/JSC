...
public class PrivacyActivity extends BaseActivity {
    ...
    public void initData() {
        //是否轨迹保护 0 不保护，1 保护
        isProtect = !"0".equals(MyApplication.getUserBean().travelprotect);//根据后台存储的状态判断是否开启保护
...
//                            SharedPreferenceUtils.setStringSP(SP_KEY, pwd);//保存密码
                            MyApplication.getUserBean().travelprotect = pwd;
...
//                            SharedPreferenceUtils.setStringSP(SP_KEY, "");//清空密码
                            MyApplication.getUserBean().travelprotect = "0";
