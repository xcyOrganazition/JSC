...
public class UserProfileActivity extends BaseActivity implements OnClickListener {
    ...
    public void initView() {
        headAvatar = findViewById(R.id.user_head_avatar);
        headPhotoUpdate = findViewById(R.id.user_head_headphoto_update);
        tvUsername = findViewById(R.id.user_username);
        rlNickName = findViewById(R.id.rl_nickname);
        tvNickName = findViewById(R.id.user_nickname);
        iconRightArrow = findViewById(R.id.ic_right_arrow);
